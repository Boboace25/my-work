...
//  if(number <= 20){console.log(20 - number);}
//  else if(number >= 20){console.log((number - 20) * 2);}
//  else{console.log('enter a number.');}
// // OR

// let num1 = +prompt('Enter your number');
// let num2 = 20
// if (num1 >= 20){console.log((num1 - 20)*2);}
// else if(num1 <= 20){console.log(20 - num1);}
// else{console.log('enter a number!');}
...
// if(num1 > num2 && num1 > num3){console.log(`${num1} is the greatest numbers`);}
// else if(num2 > num1 && num2 > num3){console.log(`${num2} is the greatest numbers`);}
// else if(num3 > num1 && num3 > num2){console.log(`${num3} is the greatest numbers`);}
// else if (num2 === num3 || num2 === num1 || num3 === num1){console.log('please enter different values');}
// else{console.log('please enter a number');}

// OR3

// let num1 = +prompt('Enter num1 number.');
// let num2 = +prompt('ENter num2 number.');
// let num3 = +prompt('enter num3 number.');
// if(num1 > num2 && num1 > num3){console.log(`${num1} is the biggest.`);}
// else if(num2 > num1 && num2 > num3){console.log(`${num2} is the biggest`);}
// else {console.log(`${num3} is the biggest.`);}
...
// if (product > 0){console.log("sign is '+'");}
// else if (product < 0 ){console.log("sign is '-'");}
// else if (prodct ===0){console.log("product is 0");}
// else {console.log('enter a number.');}
// ******************************
...
// if(number >= 50 && number <=100){console.log(`${number} is in the range 50 to 100.`);}
// else if(number < 50 || number > 100){console.log(`${number} is not in the range 50 to 100.`);}
...
// if (difference1 < difference2){console.log(`${num1} is closer to 100`);}
// else if(difference2 < difference1){console.log(`${num2} is closer to 100`);}
// else if (difference1 === difference2){console.log(`${num1} and ${num2} have the same distance to 100`);}
...
//     case 'Tuesday':
//         console.log(`${Tuesday} is weekday`);
//         break;

//         case 'Wensday':
//             console.log(`${Wensday} is weekday`);
//             break;
...
//                     case 'Saturday':
//                         console.log(`${Saturday} is not weekday`);
//                         break;

//                         case 'Sunday':
//                             console.log(`${Sunday} is not weekday`);
//                             break;
